...
function Header() {
    const { user, wishlist, cart } = useContext(ProductsContext);
                                            ...
                                            <div className="bb-flex-justify">
                                                <div className="bb-header-buttons">
                                                    <div className="bb-acc-drop"><div
                                                        ...
                                                        <div className="bb-btn-desc"><span className="bb-btn-title">{user?.username ? "Hi," : "Account"}</span><span
                                                            className="bb-btn-stitle">{user?.username ? user.username : "Login"}</span></div>
                                                    </div>
                                                        ...
                                                        <div className="bb-btn-desc"><span className="bb-btn-title"><b
                                                            className="bb-wishlist-count">{wishlist?.length || 0}</b> items</span><span
                                                        ...
                                                        <div className="bb-btn-desc"><span className="bb-btn-title"><b
                                                            className="bb-cart-count">{cart?.length || 0}</b> items</span><span
                                ...
                                <li><span className="menu-toggle"></span><a role="button">Products</a>
                                    <ul style={{ display: "none" }} className="sub-menu height-transition-1s-ease collapse">
                                        {categories.map((cat, index) => (
                                            <li key={index} value={cat.category}><NavLink to={`/product/` + cat.category}>{cat.category}</NavLink></li>
                                        ))}
                                    </ul>
                                </li>
